...
plt.plot(tmpdf['epoc'], tmpdf['l1d'], label='l1d')  # Plot some data on the (implicit) axes.
plt.plot(tmpdf['epoc'], tmpdf['l2'], label='l2')  # etc.
plt.plot(tmpdf['epoc'], tmpdf['l3'], label='l3')
plt.xlabel('epoc')
