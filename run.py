...
fileName=['customLog_3.log','customLog_5.log','customLog_7.log','customLog_9.log','customLog_10.log']
legend=['Epocwise LP prediction type','Epocwise Cache H-M rate','Epocwise Cache-levelwise H-M rate','EpocWise H-M rate in LP','Epocwise Cache-levelwise skip occurence in LP']
